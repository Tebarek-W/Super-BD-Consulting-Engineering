...
const projects: Project[] = [
    {
        ...
        image: "/images/roads-bridges-modern.jpg",
    },
    {
        ...
        image: "/images/buildings-modern.jpg",
    },
    {
        ...
        image: "/images/dams-irrigation-modern.jpg",
    },
];
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {projects.map((project, index) => (
                        <div key={index} className="bg-neutral border border-neutral-light/20 rounded-lg overflow-hidden hover:border-accent/50 hover:shadow-xl hover:shadow-accent/10 transition-all duration-300 group">
                            <div className="h-48 bg-neutral relative overflow-hidden">
                                {project.image ? (
                                    <img
                                        src={project.image}
                                        alt={project.title}
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-background-dark to-background" />
                                )}
                                {/* Overlay */}
                                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
                                <div className="absolute bottom-4 left-4 bg-accent text-white px-3 py-1 rounded text-xs font-bold z-10 shadow-lg">
                                    {project.category}
                                </div>
                            </div>
                            <div className="p-6">
